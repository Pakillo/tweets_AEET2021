...
```{r cloud_hashtags, fig.width=8, fig.height=8, eval=FALSE}
wordcloud(tweets, "hashtags", min_count = 2, min_size = 1, max_words = 70)
```

### Wordcloud {.no-title .mobile}

```{r cloud_hashtags_mob, eval=FALSE}
...
```{r cloud_mentions, fig.width=8, fig.height=8, eval=FALSE}
wordcloud(tweets, "mentions", min_count = 2, min_size = 1, max_words = 70)
```

### Wordcloud {.no-title .mobile}

```{r cloud_mentions_mob, eval=FALSE}
