...
### `r #icon::fontawesome("heart")` MOST LIKED 
...
### `r #icon::fontawesome("retweet")` MOST RETWEETED
...
### `r #icon::fontawesome("clock")` MOST RECENT
...
for (i in seq_len(n)) {
  # cat("\n\n### \n\n")
  # print_tweet(ml[i, ])
  # tweet_embed(tweet_url(screen_name = ml$user_id[i], status_id = ml$status_id[i]))
}
tweet_embed(tweet_url(screen_name = ml$user_id[1], status_id = ml$status_id[1]))
tweet_embed(tweet_url(screen_name = ml$user_id[2], status_id = ml$status_id[2]))
tweet_embed(tweet_url(screen_name = ml$user_id[3], status_id = ml$status_id[3]))
tweet_embed(tweet_url(screen_name = ml$user_id[4], status_id = ml$status_id[4]))
tweet_embed(tweet_url(screen_name = ml$user_id[5], status_id = ml$status_id[5]))
tweet_embed(tweet_url(screen_name = ml$user_id[6], status_id = ml$status_id[6]))
tweet_embed(tweet_url(screen_name = ml$user_id[7], status_id = ml$status_id[7]))
# tweet_embed(tweet_url(screen_name = ml$user_id[8], status_id = ml$status_id[8]))
